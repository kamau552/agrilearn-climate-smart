...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section - Reduced height for md screens */}
      <section className="relative h-[60vh] md:h-[50vh] lg:h-[60vh] flex items-center justify-center overflow-hidden rounded-lg">
        ...
        {/* Hero Content - Adjusted for smaller height */}
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 w-full">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 leading-tight">
            ...
            <span className="block text-green-300 mt-1 md:mt-2">Changing Climate 🌍</span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg mb-4 md:mb-6 text-green-100 max-w-2xl mx-auto leading-relaxed">
            Get AI-powered advice for climate-smart farming tailored to Kenyan smallholders
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 md:mb-10">
            ...
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
              Discover climate-resilient crops, livestock, and fruits perfect for Kenyan farmers
            </p>
          </div>
          ...
          <div className="flex justify-center mb-6 md:mb-10">
            <div className="bg-white rounded-xl shadow-lg p-2 inline-flex flex-wrap gap-2 justify-center">
              <a href="#crops" className="px-3 md:px-6 py-2 md:py-3 rounded-lg font-semibold text-green-700 hover:bg-green-50 transition-colors duration-300 flex items-center gap-2">
                <RiPlantLine />
                Crops
              </a>
              <a href="#livestock" className="px-3 md:px-6 py-2 md:py-3 rounded-lg font-semibold text-green-700 hover:bg-green-50 transition-colors duration-300 flex items-center gap-2">
                <PiCow />
                Livestock
              </a>
              <a href="#fruits" className="px-3 md:px-6 py-2 md:py-3 rounded-lg font-semibold text-green-700 hover:bg-green-50 transition-colors duration-300 flex items-center gap-2">
                <RiAppleLine />
                Fruits
              </a>
            </div>
                  ...
                  <div className="relative h-32 md:h-40 bg-green-100 overflow-hidden">
                    {crop.image ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-4xl md:text-5xl">{crop.emoji}</span>
                      </div>
                    )}
                  </div>
                  
                  <div className="p-3 md:p-4">
                    <h4 className="font-bold text-green-800 text-base md:text-lg mb-1">{crop.name}</h4>
                    <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3">{crop.localName}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {featuredLivestock.map((animal) => (
                ...
                >
                  ...
                  <div className="p-3 md:p-4">
                    <h4 className="font-bold text-green-800 text-base md:text-lg mb-1">{animal.name}</h4>
                    <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3">{animal.localName}</p>
                    <div className="flex flex-wrap gap-1 mb-2 md:mb-3">
                ...
                >
                  ...
                  <div className="relative h-32 md:h-40 bg-orange-100 overflow-hidden">
                    {fruit.image ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-4xl md:text-5xl">{fruit.emoji}</span>
                      </div>
                    )}
                  </div>
                  
                  <div className="p-3 md:p-4">
                    <h4 className="font-bold text-green-800 text-base md:text-lg mb-1">{fruit.name}</h4>
                    <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3">{fruit.localName}</p>
                    <div className="flex flex-wrap gap-1 mb-2 md:mb-3">
      ...
      <section className="py-8 md:py-12 bg-green-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 md:mb-10">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3">Why Choose AgriLearn?</h2>
            <p className="text-sm md:text-base text-green-200 max-w-2xl mx-auto">
              Empowering Kenyan small-scale farmers with climate-smart agricultural solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            <div className="text-center p-4 md:p-6">
              ...
              <h3 className="text-base md:text-lg font-bold mb-2">AI-Powered Advice</h3>
              <p className="text-green-200 text-xs md:text-sm">
                Get personalized farming recommendations based on your location and climate
              </p>
            </div>
            ...
            <div className="text-center p-4 md:p-6">
              ...
              <h3 className="text-base md:text-lg font-bold mb-2">Climate Resilient</h3>
              <p className="text-green-200 text-xs md:text-sm">
                Discover crops and practices that thrive in Kenya&apos;s changing climate
              </p>
            </div>
            ...
            <div className="text-center p-4 md:p-6">
              ...
              <h3 className="text-base md:text-lg font-bold mb-2">Smallholder Focused</h3>
              <p className="text-green-200 text-xs md:text-sm">
